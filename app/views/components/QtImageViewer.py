        ...
        if event.button() == Qt.LeftButton:          
            ...
            if self.hasImage():
                ...
                if self.dragSelect:
                    ...
                    print(selectionBBox)
                    self.areaSelected.emit(selectionBBox.x(), selectionBBox.y(),
                                                       selectionBBox.width(), selectionBBox.height())
                else:
...
if __name__ == '__main__':
    ...
    image = QImage('../samples/DJI_0152.JPG')
    viewer.setPixelPickMode(pick_by_area=True)
