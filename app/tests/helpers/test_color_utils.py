...
def test_get_color_range_below_min():
    base_color = (10, 20, 30)
...
def test_get_color_range_exact_bounds():
    base_color = (0, 0, 0)
...
def test_get_color_range_upper_bounds():
