...
from algorithms.ColorRange.controllers.ColorRangeWizardController import ColorRangeWizardController
from algorithms.RXAnomaly.controllers.RXAnomalyWizardController import RXAnomalyWizardController
from algorithms.MatchedFilter.controllers.MatchedFilterWizardController import MatchedFilterWizardController
from algorithms.MRMap.controllers.MRMapWizardController import MRMapWizardController
from algorithms.AIPersonDetector.controllers.AIPersonDetectorWizardController import AIPersonDetectorWizardController
from algorithms.HSVColorRange.controllers.HSVColorRangeWizardController import HSVColorRangeWizardController
from algorithms.ThermalRange.controllers.ThermalRangeWizardController import ThermalRangeWizardController
from algorithms.ThermalAnomaly.controllers.ThermalAnomalyWizardController import ThermalAnomalyWizardController
...
class AlgorithmParametersPage(BasePage):
    ...
    def _load_algorithm_widget(self):
        ...
        try:
            ...
            logger.info(f"Algorithm: {self.active_algorithm.get('name')}, Wizard Controller: {wizard_controller_name}, Regular Controller: {controller_class_name}")
