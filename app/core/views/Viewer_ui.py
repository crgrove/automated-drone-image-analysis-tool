...
class Ui_Viewer(object):
    def setupUi(self, Viewer):
        ...
        self.ButtonLayout.addWidget(self.KmlButton)
        ...
        self.ButtonLayout.addWidget(self.PdfButton)
    ...
    def retranslateUi(self, Viewer):
        ...
        self.PdfButton.setText(_translate("Viewer", " Generate PDF"))
