...
class Ui_Viewer(object):
    def setupUi(self, Viewer):
        ...
        self.thumbnailScrollArea.setMaximumSize(QtCore.QSize(16777215, 120))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1020, 69))
