...
class Ui_Viewer(object):
    def setupUi(self, Viewer):
        ...
        self.fileNameLabel.setMinimumSize(QtCore.QSize(10, 0))
        font = QtGui.QFont()
        ...
        self.line_3 = QtWidgets.QFrame(self.TitleWidget)
        self.line_3.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.horizontalLayout_2.addWidget(self.line_3)
        self.showOverlayCheckBox = QtWidgets.QCheckBox(self.TitleWidget)
        self.showOverlayCheckBox.setObjectName("showOverlayCheckBox")
        self.horizontalLayout_2.addWidget(self.showOverlayCheckBox)
        self.highlightPixelsOfInterestCheckBox = QtWidgets.QCheckBox(self.TitleWidget)
        self.highlightPixelsOfInterestCheckBox.setObjectName("highlightPixelsOfInterestCheckBox")
        self.horizontalLayout_2.addWidget(self.highlightPixelsOfInterestCheckBox)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.adjustmentsButton = QtWidgets.QToolButton(self.TitleWidget)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/dark/adjustments.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.adjustmentsButton.setIcon(icon1)
        self.adjustmentsButton.setIconSize(QtCore.QSize(25, 25))
        self.adjustmentsButton.setObjectName("adjustmentsButton")
        self.horizontalLayout_2.addWidget(self.adjustmentsButton)
        self.measureButton = QtWidgets.QToolButton(self.TitleWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.measureButton.setFont(font)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/ruler.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.measureButton.setIcon(icon2)
        self.measureButton.setIconSize(QtCore.QSize(25, 25))
        self.measureButton.setObjectName("measureButton")
        self.horizontalLayout_2.addWidget(self.measureButton)
        self.line_4 = QtWidgets.QFrame(self.TitleWidget)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/map.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/pdf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/zip.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/previous.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(260, 0, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Viewer):
        ...
        self.showOverlayCheckBox.setText(_translate("Viewer", "Show Overlay"))
        self.highlightPixelsOfInterestCheckBox.setText(_translate("Viewer", "Highlight Pixels of Interest"))
        self.adjustmentsButton.setToolTip(_translate("Viewer", "Adjust Image (Ctrl+H)"))
        self.adjustmentsButton.setText(_translate("Viewer", "..."))
        self.adjustmentsButton.setProperty("iconName", _translate("Viewer", "adjustments.png"))
        self.measureButton.setToolTip(_translate("Viewer", "Measure Distance (Ctrl+M)"))
        self.measureButton.setText(_translate("Viewer", "..."))
        self.measureButton.setProperty("iconName", _translate("Viewer", "ruler.png"))
        self.kmlButton.setToolTip(_translate("Viewer", "Generate KML"))
        self.kmlButton.setText(_translate("Viewer", "..."))
        self.kmlButton.setProperty("iconName", _translate("Viewer", "map.png"))
        self.pdfButton.setToolTip(_translate("Viewer", "Generate PDF Report"))
        self.pdfButton.setText(_translate("Viewer", "..."))
        self.pdfButton.setProperty("iconName", _translate("Viewer", "pdf.png"))
        self.zipButton.setToolTip(_translate("Viewer", "Generate Zip Bundle"))
        self.zipButton.setText(_translate("Viewer", "..."))
        self.zipButton.setProperty("iconName", _translate("Viewer", "zip.png"))
