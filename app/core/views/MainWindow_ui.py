...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.maxAreaSpinBox.setMinimum(1)
        self.maxAreaSpinBox.setMaximum(999999)
        self.maxAreaSpinBox.setProperty("value", 20)
