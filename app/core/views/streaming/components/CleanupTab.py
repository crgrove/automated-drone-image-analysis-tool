...
class CleanupTab(TranslationMixin, QWidget):
    ...
    def setup_ui(self):
        ...
        # Temporal Voting
        temporal_group = QGroupBox(self.tr("Temporal Voting"))
        ...
        # Detection Cleanup
        cleanup_group = QGroupBox(self.tr("Detection Cleanup"))
        ...
        clustering_group = QGroupBox(self.tr("Detection Clustering"))
