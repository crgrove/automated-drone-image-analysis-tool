    ...
    def process_image(self, img, full_path, input_dir, output_dir):
        ...
        try:
            ...
            if hue_expansion_enabled and hue_expansion_range > 0 and areas_of_interest:
                # Convert combined_mask to 0-255 range for hue expansion
                mask_255 = combined_mask * 255

                # Apply hue expansion to the mask (using original BGR image)
            ...
            if areas_of_interest:
                # Convert to 0-255 range for storage
                mask_to_store = combined_mask * 255
                mask_path = self.store_mask(full_path, output_path, mask_to_store)
