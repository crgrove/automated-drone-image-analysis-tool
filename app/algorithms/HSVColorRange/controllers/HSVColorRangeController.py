...
class HSVColorRangeController(QWidget, Ui_HSVColorRange, AlgorithmController):
    ...
    def on_ranges_changed(self):
        ...
        if self.selectedColor and self._hsv_window:
            ...
            h_center, s_center, v_center = self._hsv_window['h'], self._hsv_window['s'], self._hsv_window['v']
    ...
    def color_button_clicked(self):
        ...
        try:
            ...
            if dialog.exec() == ColorRangeDialog.Accepted:
                ...
                h_center_norm = hsv_data['h']
                s_center_norm = hsv_data['s']
                v_center_norm = hsv_data['v']
    ...
    def get_options(self):
        ...
        if self._hsv_window is not None:
            ...
            if hasattr(self, 'hueMinusSpinBox'):
                ...
                options['saturation_threshold'] = int((self.saturationMinusSpinBox.value() + self.saturationPlusSpinBox.value()) / 2)
